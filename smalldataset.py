...
def interactions():
	...
	if(dataset == "Actual"):
		...
		smallfiltermethodcalls.filter("roughrough_new_trial.txt")
	...
	if(len(file_name) > 0):
		...
		data = smallfiltermethodcalls.parse()
	...
	print(len(after_insertion_data))
	print(after_insertion_data)

	precomputed_pos, rect_data, maximum_height, maximum_width = precalc.precalc(after_insertion_data)
